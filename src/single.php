                ...
                <div class="row">
                    <?php if ($recipe_product_1): ?>
                        <div class="col-sm-3 col-lg-2">
                            <div class="post__related-product post__related-product--first product">
                                <a href="<?php echo get_permalink( $product_1->get_id()); ?>"><?php echo get_the_post_thumbnail( $recipe_product_1->ID, array( 300, 300) ); ?></a>
                    ...
                    <?php if ($recipe_product_2): ?>
                        <div class="col-sm-3 col-lg-2">
                            <div class="post__related-product post__related-product--first product">
                                <a href="<?php echo get_permalink( $product_2->get_id()); ?>"><?php echo get_the_post_thumbnail( $recipe_product_2->ID, array( 300, 300) ); ?></a>
                    ...
                    <?php if ($recipe_product_3): ?>
                        <div class="col-sm-3 col-lg-2">
                            <div class="post__related-product post__related-product--first product">
                                <a href="<?php echo get_permalink( $product_3->get_id()); ?>"><?php echo get_the_post_thumbnail( $recipe_product_3->ID, array( 300, 300) ); ?></a>
                    ...
                    <?php if ($recipe_product_4): ?>
                        <div class="col-sm-3 col-lg-2">
                            <div class="post__related-product post__related-product--first product">
                                <a href="<?php echo get_permalink( $product_4->get_id()); ?>"><?php echo get_the_post_thumbnail( $recipe_product_4->ID, array( 300, 300) ); ?></a>
                    ...
                    <?php if ($recipe_product_5): ?>
                        <div class="col-sm-3 col-lg-2">
                            <div class="post__related-product post__related-product--first product">
                                <a href="<?php echo get_permalink( $product_5->get_id()); ?>"><?php echo get_the_post_thumbnail( $recipe_product_5->ID, array( 300, 300) ); ?></a>
                    ...
                    <?php if ($recipe_product_6): ?>
                        <div class="col-sm-3 col-lg-2">
                            <div class="post__related-product post__related-product--first product">
                                <a href="<?php echo get_permalink( $product_6->get_id()); ?>"><?php echo get_the_post_thumbnail( $recipe_product_6->ID, array( 300, 300) ); ?></a>
